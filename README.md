...
#### Thanks for taking time :clock: to stop by and please feel to star :star:, fork the repository or report any bug :beetle: in the code in the issues section of the repository. :smiley:
